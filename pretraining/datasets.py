...
# def cpc_dataset(db_dir, patient_ids, frame_size, context_size, ns, context_overlap=0, positive_offset=0,
#                 num_buffered_patients=16, normalize=True, unzipped=False, samples_per_patient=1):
#
#     dataset = tf.data.Dataset.from_generator(generator=cpc_generator,
...
#                                                    positive_offset, num_buffered_patients, normalize, unzipped,
#                                                    samples_per_patient))
#     return dataset
#
#
# def cpc_generator(db_dir, patient_ids, frame_size, context_size, ns, context_overlap=0, positive_offset=0,
#                   num_buffered_patients=16, normalize=True, unzipped=False, samples_per_patient=1):
#
#     patient_generator = icentia11k.uniform_patient_generator(_str(db_dir), patient_ids,
#                                                              unzipped=bool(unzipped),
...
#
#     patient_generator = buffered_generator(patient_generator, buffer_size=int(num_buffered_patients))
#
#     data_generator = icentia11k.cpc_data_generator(patient_generator, context_size=int(context_size), ns=int(ns),
#                                                    frame_size=int(frame_size), context_overlap=int(context_overlap),
#                                                    positive_offset=int(positive_offset),
#                                                    samples_per_patient=int(samples_per_patient))
#     if normalize:

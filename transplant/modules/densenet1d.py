...
class _DenseNet(tf.keras.Model):
    ...
    def __init__(self, input_shape=(None, None), num_outputs=1, blocks=(6, 12, 24, 16), first_num_channels=64, growth_rate=32,
        ...
        print(input_shape)
        self.input_layer = tf.keras.layers.Input(shape=input_shape[0], dtype=input_shape[1])
